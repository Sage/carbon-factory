...
exports.default = function (opts) {
  ...
  return function () {
    ...
    var parcelified = (0, _parcelify2.default)(browserified, {
      ...
      // write the css file
      return _gulp2.default.src(cssDest + '/' + cssFile).pipe((0, _gulpIf2.default)(assetsUrl, (0, _gulpCssReplaceUrl2.default)({ prepend: assetsUrl }))).pipe((0, _gulpCleanCss2.default)()).pipe((0, _gulpIf2.default)(production && gzip, (0, _gulpGzip2.default)({ append: false }))).pipe(_gulp2.default.dest(cssDest));
    });
