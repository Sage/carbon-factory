...
exports.default = function (opts) {
  ...
  return function () {
    ...
    if (watch && argv.hot) {
      plugins.push(_livereactload2.default);
    }

    if (typescript) {
      plugins.push(_tsify2.default);
    }
    ...
    if (babelTransforms.length) {
      ...
      babelTransforms.forEach(function (module) {
    ...
    var browserified = (0, _browserify2.default)(browserifyOpts).transform("babelify", babelTransformOptions).transform(envifyTransform, { global: true });
    ...
    var parcelified = (0, _parcelify2.default)(browserified, {
      ...
      _gulpUtil2.default.log(_gulpUtil2.default.colors.green("Assets are compiled!"));
      ...
      _gulp2.default.src(fonts).pipe((0, _gulpIf2.default)(production && gzip, (0, _gulpGzip2.default)({ append: false }))).pipe(_gulp2.default.dest(fontDest));
      ...
      // write the css file
      return _gulp2.default.src(cssDest + '/' + cssFile).pipe((0, _gulpIf2.default)(!!assetsUrl, (0, _gulpCssReplaceUrl2.default)({ prepend: assetsUrl }))).pipe((0, _gulpHoistCssImports2.default)()).pipe((0, _gulpCleanCss2.default)()).pipe((0, _gulpIf2.default)(production && gzip, (0, _gulpGzip2.default)({ append: false }))).pipe(_gulp2.default.dest(cssDest));
    });
    ...
    function build(f) {
      ...
      message = _gulpUtil2.default.colors.green(message);
      message += '(please wait)';
      var spinner = new _cliSpinner.Spinner('%s ' + message);
      ...
      if (!f) {
        ...
        _gulpUtil2.default.log(_gulpUtil2.default.colors.yellow('File changed: ') + f);
        spinner.start();
      }

      return bundler.bundle().on('error', function (error) {
        _gulpUtil2.default.log("*** Browserify Error ***");console.log(error);
      }).on('error', handleError).pipe((0, _vinylSourceStream2.default)(jsFile)).pipe((0, _gulpIf2.default)(production && doUglify, (0, _gulpStreamify2.default)((0, _gulpUglify2.default)()))).pipe((0, _gulpIf2.default)(production && gzip, (0, _gulpGzip2.default)({ append: false }))).pipe(_gulp2.default.dest(jsDest)).on('end', function () {
        spinner.stop(true);
        if (f) {
          _gulpUtil2.default.log(_gulpUtil2.default.colors.green('Recompiled: ') + f);
        }
      });
    };
...
var _tsify = require('tsify');

var _tsify2 = _interopRequireDefault(_tsify);
...
var _gulpCssReplaceUrl = require('gulp-css-replace-url');

var _gulpCssReplaceUrl2 = _interopRequireDefault(_gulpCssReplaceUrl);
...
var _gulpHoistCssImports = require('gulp-hoist-css-imports');

var _gulpHoistCssImports2 = _interopRequireDefault(_gulpHoistCssImports);
