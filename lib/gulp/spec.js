...
exports.default = function (opts) {
  ...
  return function (done) {
    ...
    /*istanbul ignore next*/_fs2.default.stat(originPath + '/.eslintrc', function (err, stat) {
      if (err == null) {
        return;
      }
      if (err.code == 'ENOENT') {
        /*istanbul ignore next*/_gulpUtil2.default.log( /*istanbul ignore next*/_gulpUtil2.default.colors.red("Cannot find '.eslintrc' file"));
        /*istanbul ignore next*/_gulpUtil2.default.log( /*istanbul ignore next*/_gulpUtil2.default.colors.white("Create an '.eslintrc' file in the root of your project and add the following code:\n{\n  \"extends\": \"./node_modules/carbon-factory/.eslintrc\"\n}"));
        process.exit();
      }
    });
    ...
    var config = {
      ...
      browserify: {
        ...
        transform: [/*istanbul ignore next*/_babelify2.default.configure({
    ...
    if (argv.b == 'all') {
      ...
      config.browsers = [/*istanbul ignore next*/(0, _string2.default)(argv.b).capitalize().s];
    ...
    if (argv.build || argv.coverage) {
      ...
      config.browserify.transform.push( /*istanbul ignore next*/(0, _browserifyIstanbul2.default)({
    ...
    var server = new Server(config, function (status) {
      if (status) {
        /*istanbul ignore next*/_gulpUtil2.default.log( /*istanbul ignore next*/_gulpUtil2.default.colors.red('UI Tests FAILED'));
      } else {
        /*istanbul ignore next*/_gulpUtil2.default.log( /*istanbul ignore next*/_gulpUtil2.default.colors.green('UI Tests SUCCEEDED'));
      }
...
var /*istanbul ignore next*/_string = require('string');

/*istanbul ignore next*/var _string2 = _interopRequireDefault(_string);

var /*istanbul ignore next*/_yargs = require('yargs');

/*istanbul ignore next*/var _yargs2 = _interopRequireDefault(_yargs);

var /*istanbul ignore next*/_karma = require('karma');

/*istanbul ignore next*/var _karma2 = _interopRequireDefault(_karma);

var /*istanbul ignore next*/_browserifyIstanbul = require('browserify-istanbul');

/*istanbul ignore next*/var _browserifyIstanbul2 = _interopRequireDefault(_browserifyIstanbul);
...
/*istanbul ignore next*/var _fs2 = _interopRequireDefault(_fs);
...
var Server = /*istanbul ignore next*/_karma2.default.Server;